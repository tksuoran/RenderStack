...
mesh::mesh()
    : m_vertex_buffer(nullptr), m_index_buffer(nullptr), m_first_vertex(0), m_first_index(0), m_vertex_count(0), m_index_count(0), m_next_index_range_start(0)
{
}

shared_ptr<renderstack::graphics::buffer> mesh::vertex_buffer() const
{
    return m_vertex_buffer;
}
shared_ptr<renderstack::graphics::buffer> mesh::index_buffer() const
{
