...
shared_ptr<Buffer> mesh::vertex_buffer() const
{
    return m_vertex_buffer;
}

shared_ptr<Buffer> mesh::index_buffer() const
{
    return m_index_buffer;
}

size_t mesh::first_vertex() const
{
    return m_first_vertex;
}

size_t mesh::first_index() const
{
...
void mesh::allocate_vertex_buffer(Renderer                     &renderer,
                                  size_t                       vertex_stride,
                                  size_t                       vertex_count,
                                  gl::buffer_usage_hint::value usage)
{
    slog_trace("mesh::allocate_vbo(vertex_stride = %u, vertex_count = %u, usage = %s)",
...
void mesh::allocate_vertex_buffer(shared_ptr<Buffer> vertex_buffer,
                                  size_t             vertex_count)
{
    slog_trace("mesh::allocate_vertex_buffer(vertex_buffer = %p, vertex_count = %u)",
               vertex_buffer.get(),
               static_cast<unsigned int>(vertex_count));
...
void mesh::allocate_index_buffer(Renderer &renderer, size_t index_stride, size_t index_count, gl::buffer_usage_hint::value usage)
{
    slog_trace("mesh::allocate_ibo(index_stride = %u, index_count = %u, usage = %s)",
...
void mesh::allocate_index_buffer(shared_ptr<Buffer> index_buffer, size_t index_count)
{
    slog_trace("mesh::allocate_ibo(ibo_pool = %p, index_count = %u)",
               index_buffer.get(),
               static_cast<unsigned int>(index_count));
...
void mesh::allocate_index_range(gl::begin_mode::value begin_mode, size_t index_count, Index_range &range)
{
    slog_trace("mesh::allocate_index_range(begin_mode = %s, index_count = %u, index_range = %p)",
...
void mesh::set_first_vertex(size_t value)
{
    m_first_vertex = value;
}

void mesh::set_first_index(size_t value)
{
    m_first_index = value;
}
...
{
    m_vertex_count = value;
}

void mesh::set_index_count(size_t value)
{
    m_index_count = value;
}
