...
public:
    ...
    index_range const &fill_indices() const
    {
        return m_fill_indices;
    }
    index_range const &edge_line_indices() const
    {
        return m_edge_line_indices;
    }
    index_range const &corner_point_indices() const
    {
        return m_corner_point_indices;
    }
    index_range const &polygon_centroid_indices() const
    {
