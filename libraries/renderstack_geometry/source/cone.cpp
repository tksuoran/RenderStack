...
*/
struct conical_frustum::make_info
{
   double   min_x;
   double   max_x;
...
point *conical_frustum::get_point(make_info &info, int slice, int stack)
{
...
point *conical_frustum::cone_point(make_info &info, double rel_slice, double rel_stack_in)
{
...
corner *conical_frustum::make_corner(make_info &info, polygon *polygon, int slice, int stack)
{
   return make_corner(info, polygon, slice, stack, false);
}
corner *conical_frustum::make_corner(make_info &info, polygon *polygon, int slice, int stack, bool cap)
{
