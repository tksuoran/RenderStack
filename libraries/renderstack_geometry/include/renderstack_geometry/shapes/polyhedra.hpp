...
*/
   ...
   {
      add_point(x, y, z);
      if (sx) add_points_sign(-x,  y, z,  0.0,  sy, sz);
      if (sy) add_points_sign( x, -y, z,  0.0, 0.0, sz);
      if (sz) add_point(x, y, -z);
   }
...
{
   hexahedron() : polyhedron("hexahedron")
   {
...
class weirdahedron() : public polyhedron
{
...
class cuboctahedron() : public polyhedron
{
...
class icosidodecahedron() : public polyhedron
{
   cuboctahedron()
   {
...
class truncated_tetrahedron() : public polyhedron
{
   truncated_tetrahedron(bool augmentation)
   :  polyhedron(augmentation ? "augmented truncated tetrahedron" : "truncated tetrahedron")
   {
...
class truncated_hexahedron() : public polyhedron
{
...
class truncated_octahedron() : public polyhedron
{
...
class truncated_dodecahedron() : public polyhedron
{
