...
public:
   ...
   void smooth_average(
      ...
      std::shared_ptr<property_map<renderstack::geometry::corner*,   glm::vec3> >    normer_normals,
      std::shared_ptr<property_map<renderstack::geometry::point*,    glm::vec3> >    point_normals
   );

   void compute_normal(
      std::shared_ptr<property_map<renderstack::geometry::polygon*, glm::vec3> >    polygon_normals,
      std::shared_ptr<property_map<renderstack::geometry::point*,   glm::vec3> >    point_locations
   );
   void compute_centroid(
      std::shared_ptr<property_map<renderstack::geometry::polygon*, glm::vec3> >    polygon_centroids,
      std::shared_ptr<property_map<renderstack::geometry::point*,   glm::vec3> >    point_locations
   );
   ...
   renderstack::geometry::corner *next_corner (renderstack::geometry::corner *corner);
   renderstack::geometry::corner *prev_corner (renderstack::geometry::corner *corner);
