...
public:
    ...
    typedef std::map<edge, std::set<polygon *>>           edge_collection;
    ...
    struct mesh_info
    {
        ...
        mesh_info()
            : polygon_count(0), corner_count(0), triangle_count(0), edge_count(0), vertex_count_corners(0), vertex_count_centroids(0), index_count_fill_triangles(0), index_count_edge_lines(0), index_count_corner_points(0), index_count_centroid_points(0)
        {
        }
