...
public:
    ...
    std::shared_ptr<style> default_style() const
    {
        return m_default_style;
    }
    std::shared_ptr<style> null_padding_style() const
    {
        return m_null_padding_style;
    }
    std::shared_ptr<style> button_style() const
    {
        return m_button_style;
    }
    std::shared_ptr<style> menulist_style() const
    {
        return m_menulist_style;
    }
    std::shared_ptr<style> choice_style() const
    {
        return m_choice_style;
    }
    std::shared_ptr<style> colorpicker_style() const
    {
        return m_colorpicker_style;
    }
    std::shared_ptr<style> slider_style() const
    {
        return m_slider_style;
    }

    std::shared_ptr<class renderstack::graphics::renderer> renderer() const
    {
        return m_renderer;
    }
    ...
    std::shared_ptr<renderstack::graphics::vertex_stream> vertex_stream() const
    {
