...
{
public:
    glm::vec2 const &padding() const
    {
        return m_padding;
    }
    glm::vec2 const &inner_padding() const
    {
        return m_inner_padding;
    }
    std::shared_ptr<class font> font() const
    {
        return m_font;
    }
    std::shared_ptr<class ninepatch_style> ninepatch_style() const
    {
        return m_ninepatch_style;
    }
    ...
    style(
        ...
        : m_padding(padding_in), m_inner_padding(inner_padding_in), m_font(nullptr), m_ninepatch_style(nullptr), m_program(nullptr), m_texture_unit(0)
    {
    }
    ...
    style(
        ...
        : m_padding(padding_in), m_inner_padding(inner_padding_in), m_font(font_in), m_ninepatch_style(ninepatch_style_in), m_program(program), m_texture_unit(0)
    {
    }
