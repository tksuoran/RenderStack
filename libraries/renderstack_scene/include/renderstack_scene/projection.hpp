...
public:
    ...
    void set_projection_type(projection_type::value value)
    {
        m_projection_type = value;
    }
    ...
    void set_ortho_left(float value)
    {
        m_ortho_left = value;
    }
    float ortho_width()
    ...
    void set_ortho_width(float value)
    {
        m_ortho_width = value;
    }
    float ortho_bottom()
    {
        return m_ortho_bottom;
    }
    void set_ortho_bottom(float value)
    {
        m_ortho_bottom = value;
    }
    float ortho_height()
    {
        return m_ortho_height;
    }
    void set_ortho_height(float value)
    {
        m_ortho_height = value;
    }
    float frustum_left()
    {
        return m_frustum_left;
    }
    void set_frustum_left(float value)
    {
        m_frustum_left = value;
    }
    float frustum_right()
    {
        return m_frustum_right;
    }
    void set_frustum_right(float value)
    {
        m_frustum_right = value;
    }
    float frustum_bottom()
    {
        return m_frustum_bottom;
    }
    void set_frustum_bottom(float value)
    {
        m_frustum_bottom = value;
    }
    float frustum_top()
    {
        return m_frustum_top;
    }
