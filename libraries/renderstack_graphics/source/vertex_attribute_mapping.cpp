...
vertex_attribute_mapping::vertex_attribute_mapping(
    ...
    unsigned int                  index)
    : m_name(name), m_src_usage(usage), m_dst_usage(usage), m_src_index(index), m_dst_index(index)
{
}
...
vertex_attribute_mapping::vertex_attribute_mapping(
    ...
    : m_name(name), m_src_usage(src_usage), m_dst_usage(dst_usage), m_src_index(src_index), m_dst_index(dst_index)
{
}
