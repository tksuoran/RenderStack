...
vertex_attribute::vertex_attribute(
    ...
    : m_usage(usage), m_data_type(data_type), m_shader_type(shader_type), m_index(index), m_dimension(dimension), m_offset(offset), m_normalized(normalized), m_divisor(divisor)
{
}
