...
stencil_state_component::stencil_state_component()
    : m_stencil_fail_op(gl::stencil_op_enum::keep), m_z_fail_op(gl::stencil_op_enum::keep), m_z_pass_op(gl::stencil_op_enum::keep), m_function(gl::stencil_function_enum::always), m_reference(0), m_test_mask(0xffff), m_write_mask(0xffff)
{
}

stencil_state::stencil_state()
    : m_enabled(false), m_separate(false)
{
}
