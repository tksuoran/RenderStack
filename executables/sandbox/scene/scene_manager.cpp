...
scene_manager::scene_manager()
    : service("scene_manager"), m_camera(nullptr), m_camera_controls(nullptr)
{
}
    ...
    std::shared_ptr<renderstack::geometry::geometry> geometry)
{
    ...
    auto gm = make_shared<renderstack::mesh::geometry_mesh>(r,
                                                            geometry,
                                                            m_format_info,
                                                            m_buffer_info);
