...
quad_renderer::quad_renderer()
    : service("quad_renderer"), m_renderer(nullptr)

      ,
      m_vertex_attribute_mappings(nullptr), m_vertex_format(nullptr), m_vertex_stream(nullptr), m_vertex_buffer(nullptr), m_index_buffer(nullptr)
{
}
