...
renderstack::toolkit::log_category log_game     (LOG_COLORIZER_DEFAULT, C_WHITE, C_GRAY, LOG_WARN);
renderstack::toolkit::log_category log_menu     (LOG_COLORIZER_DEFAULT, C_WHITE, C_GRAY, LOG_WARN);
